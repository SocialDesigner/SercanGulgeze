...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${mobil}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute)
         window.open("projelerim_mobil_uygulama.html", "_self");
         

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${web_tasarim}", "click", function(sym, e) {
         // insert code for mouse click here
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute)
         window.open("projelerim_web_tasarim.html", "_self");
      ...
      Symbol.bindElementAction(compId, symbolName, "${yazilim}", "click", function(sym, e) {
         ...
         // Navigate to a new URL in the current window
         // (replace "_self" with appropriate target attribute)
         window.open("projelerim_yazilim_gelistirme.html", "_self");
