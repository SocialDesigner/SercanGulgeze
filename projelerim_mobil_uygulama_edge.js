...
(function (compId) {
                ...
                content: {
                    dom: [
                        ...
                        },
                        {
                            ...
                            display: 'none',
                            type: 'text',
                            rect: ['39px', '280px', '1017px', '766px', 'auto', 'auto'],
                            opacity: 0,
                            text: "\"YAKIT HESAP\"<br>PROGRAMI YAKINDA<br>ÇOK YAKINDA<br>\"APP STORE\"<br>VE<br>BURADA YAYINDA OLACAKTIR ",
                            align: "center",
                            font: ['Arial, Helvetica, sans-serif', [91, "px"], "rgba(0,0,0,1)", "400", "none solid rgb(0, 0, 0)", "normal", "break-word", "normal"]
                        },
                        {
                            id: 'app_store2',
                            display: 'none',
                            type: 'image',
                            rect: ['48px', '1261px', '1000px', '297px', 'auto', 'auto'],
                            opacity: 0,
                            fill: ["rgba(0,0,0,0)",im+"app_store.png",'0px','0px']
                        }
                    ],
                    style: {
                        '${Stage}': {
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("projelerim_mobil_uygulama_edgeActions.js");
})("EDGE-5742815");
